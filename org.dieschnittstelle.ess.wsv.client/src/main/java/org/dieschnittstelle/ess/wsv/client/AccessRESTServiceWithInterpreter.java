...
public class AccessRESTServiceWithInterpreter {
    ...
    public static void main(String[] args) {
		 ...
		 */
        ITouchpointCRUDServiceClient serviceProxy = (ITouchpointCRUDServiceClient) Proxy.newProxyInstance(AccessRESTServiceWithInterpreter.class.getClassLoader(), new Class[] { ITouchpointCRUDServiceClient.class }, invocationHandler);
